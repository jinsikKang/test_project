...
class Volume:
    ...
    def setById(self, id):
        ...
        self.os_vol_mig_status_attr["migstat"] = volumeDic["os-vol-mig-status_attr:migstat"]
        self.os_vol_mig_status_attr["name_id"] = volumeDic["os-vol-mig-status_attr:name_id"]
